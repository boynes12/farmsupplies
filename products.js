...
const PRODUCTS = [
  // ---------- SEEDS ----------
  {
    id: "seed-cereal-mix",
    category: "seeds",
    name: "Canterra TruFlex Canola Seed",
    image: "img33.webp",
    price: "Call for pricing",
    status: "In stock",
    short: "Canterra Seeds TruFlex canola, Roundup Ready trait, selected for strong establishment.",
    description: "Canterra Seeds TruFlex canola seed, bred for strong, even establishment and suited to a Roundup Ready weed-control program. Sold in 22.7 kg (50 lb) bags. Talk to us about the variety that fits your soil, rotation, and target yield."
  },
  ...
  {
    id: "simply-hay-timothy",
    category: "livestock-care",
    name: "Simply Hay Timothy Hay",
    image: "img100.webp",
    price: "Call for pricing",
    status: "In stock",
    short: "Compressed Timothy hay, 2.8 cubic feet / 80 L per bag, Product of Canada.",
    description: "Simply Hay Timothy Hay is compressed, bagged Timothy hay from Olds, Alberta — 2.8 cubic feet (80 L) per bag. A convenient, consistent feed option for horses and small livestock, especially where loose bales are impractical to store or transport."
  },
  {
    id: "round-hay-bales",
    category: "livestock-care",
    name: "Round Hay Bales",
    image: "img99.webp",
    price: "Call for pricing",
    status: "In stock",
    short: "Field-run round hay bales, sold individually or by the load.",
    description: "Round hay bales sourced from local hay ground, suited to cattle, horses, and other livestock feeding programs. Ask us about current cutting, bale weight, and quantity pricing for individual bales or full loads."
  },
  {
    id: "tarped-hay-stack",
    category: "livestock-care",
    name: "Tarped Bulk Hay (Small Square Bales)",
    image: "img104.webp",
    price: "Call for pricing",
    status: "In stock",
    short: "Small square bale hay, stacked and tarped, sold by the stack or load.",
    description: "Small square bale hay, stacked and tarped for weather protection. Suited to horse owners and smaller operations wanting easy-to-handle bales. Ask us about current quantity on hand and load pricing."
  },
  {
    id: "bulk-liquid-tote",
    category: "fertilizers",
    name: "Bulk Liquid Fertilizer Tote",
    image: "img103.webp",
    price: "Call for pricing",
    status: "In stock",
    short: "Refillable IBC tote for bulk liquid fertilizer.",
    description: "A refillable IBC tote used for bulk liquid fertilizer supply, suited to growers who prefer to buy and store larger volumes. Ask us about tote deposits, refill pricing, and which liquid fertilizer products are available in bulk."
  },
];
